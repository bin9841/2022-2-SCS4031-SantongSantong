...
def parse_args():
    ...
    parser.add_argument(
        "--configs",
        default=("/home/irteam/dcloud-global-dir/santong/stdet_model/best_models/configs/"),
        help="spatio temporal detection config file path",
    )  # 모델 5개 config 들어있는 폴더
    parser.add_argument(
        "--checkpoints",
        default=("/home/irteam/dcloud-global-dir/santong/stdet_model/best_models/checkpoints/"),
    ...
    parser.add_argument(
        "--det-config",
        default="/home/irteam/dcloud-global-dir/santong/stdet_model/my_faster_rcnn_r50_fpn_2x_coco.py",
        help="human detection config file path (from mmdet)",
    )  # object detection 모델 config 경로
    parser.add_argument(
        "--det-checkpoint",
        default=("/home/irteam/dcloud-global-dir/santong/stdet_model/my_mmdet.pth"),
    ...
    parser.add_argument(
        "--label-map", default="/home/irteam/dcloud-global-dir/santong/stdet_model/label_map.txt", help="label map file"
    )
    parser.add_argument(
...
class ClipHelper:
    ...
    def detect_drowning(self, task):
        ...
        if self.cnt != 0 and self.cnt == 9:  # 딱 한 번만 캡처되게 저장
            ...
            # playsound.playsound('./' + 'alarm_pool' + str(pool_number) + '.mp3')
            # playsound.playsound('./' + 'alarm_pool' + str(pool_number) + '.mp3')
